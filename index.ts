...
function main(): void {
    ...
    app.set('views', 'views/pages') // specify the views directory
    app.set('view engine', 'ejs');  // view engine

    // INDEX
    app.get('/dashboard', dashboard);
    app.get('/dashboard/logout', logOut);  // redirect: limpia la cookie de auth
    app.post('/dashboard/', dashboard);    // renderiza nuevamente el dashboard para actualizar la tabla de consultas
